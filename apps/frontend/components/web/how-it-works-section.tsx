  ...
  return (
    <section className="border-b px-4">
      <div className="max-w-[1100px] mx-auto border-r border-l">
        <div className="grid grid-cols-1 sm:grid-cols-[35%_minmax(0,1fr)]">
          ...
          <div className="px-8 py-24">
            ...
            <p className="text-lg sm:text-xl text-foreground/70 mt-6">
              Make your first blog In 3 Simple Steps
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-[35%_minmax(0,1fr)]">
          <div className="pl-0 sm:pl-24 border-r hidden sm:block">
            <div className="h-full px-12 border-t flex justify-end items-center">
              <p className="text-4xl text-right">01</p>
            </div>
          </div>
          <div className="px-8 py-8">
            <h3 className="text-2xl sm:text-[28px]">Create your account</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[35%_minmax(0,1fr)]">
          ...
          <div className="px-8 py-8">
            <h3 className="text-2xl sm:text-[28px]">Write & Organize</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[35%_minmax(0,1fr)]">
          ...
          <div className="px-8 py-8">
            <h3 className="text-2xl sm:text-[28px]">Publish & Share</h3>
            <p className="text-base mt-4 leading-[1.4] text-foreground/70">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[35%_minmax(0,1fr)]">
          <div className="pl-0 sm:pl-24 border-r hidden sm:block"></div>
